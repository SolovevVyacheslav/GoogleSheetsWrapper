...
namespace GoogleSheetsWrapper
{
    ...
    /// </summary>
    public class SheetFieldValidationAttribute : Attribute
    {
        public SheetFieldValidationAttribute() { }
        ...
        {
            ConditionType = conditionType;
            UserEnteredValues = userEnteredValues;
        }
        ...
        //
        // Summary:
        //     The values of the condition. The number of supported values depends on the condition
        //     type. Some support zero values, others one or two values, and ConditionType.ONE_OF_LIST
        //     supports an arbitrary number of values.
        public virtual string[] UserEnteredValues { get; set; }

        //
        // Summary:
        //     A relative date (based on the current date). Valid only if the type is DATE_BEFORE,
        //     DATE_AFTER, DATE_ON_OR_BEFORE or DATE_ON_OR_AFTER. Relative dates are not supported
        //     in data validation. They are supported only in conditional formatting and conditional
        //     filters.
